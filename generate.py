...
# reading the files word_to_idx.pkl and idx_to_word.pkl to get the mappings between word and index
word_to_index = {}
with open ("data/word_to_idx.pkl", 'rb') as file:
    word_to_index = pd.read_pickle(file, compression=None)

index_to_word = {}
with open ("data/idx_to_word.pkl", 'rb') as file:
...
# generating captions for a random image using greedy search
...
# inputting an image and returning its encoding (feature vector)
